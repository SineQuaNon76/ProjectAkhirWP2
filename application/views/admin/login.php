...
<head>
    ...
    <!-- Google font-->
    <link rel="stylesheet" href="<?= base_url('https://fonts.googleapis.com/css?family=Poppins:300,400,500,600'); ?>">
    <!-- Required Fremwork -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form method="POST" action="<?= base_url('auth/proses_login'); ?>" class="md-float-material">
