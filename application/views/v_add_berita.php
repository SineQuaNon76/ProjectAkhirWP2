                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Data Admin</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="<?= base_url('Berita/simpan_berita'); ?>" method="POST" class="form-horizontal">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="kategori" placeholder="Masukan Kategori Berita">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea rows="5" cols="5" name="isi_berita" class="form-control" placeholder="Masukan Deskripsi Berita"></textarea>
                                                                </div>
                                                            </div>
                                                            <input type="submit" class="btn btn-inverse btn-square" value="Simpan Berita">
                                                        </form>
