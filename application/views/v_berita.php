                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Data Berita</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <a href=" <?= base_url('Berita/Tambah_berita'); ?>" button class="btn btn-inverse btn-square">Tambah Berita</button> </a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="<?= base_url() . 'Berita/edit_berita/' . $datas->id; ?>" button class="btn btn-info ">Edit</a>
                                                                        <a href="<?= base_url() . 'Berita/hapus_berita/' . $datas->id; ?>" button class="btn btn-danger">Hapus</a>
